...
control.data <- subset(indata,Detector.Name==denominator,select=c("sample.num","day.num","Detector.Name"))
gene.data <- subset(indata,Detector.Name==numerator,select=c("sample.num","day.num","Detector.Name"))
...
stripchart(rawratio~as.factor(day.num),data=indata,add=TRUE,vertical=TRUE,pch=19,col=2)
