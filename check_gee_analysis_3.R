...
fit.gee.out.perm <- fit.gee.5.array(tissue.counts.norm,matches.2.1tomany,pheno.factor,crash.list=1:n.transcripts,perm=2)
...
pdf(paste0(resultsdir,"Histograms_of_pvalues.pdf"),height=8,width=11)
